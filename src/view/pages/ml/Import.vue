      ...
      >
        ...
        <div class="wizard-nav border-bottom mb-1 mb-lg-5">
          <div class="wizard-steps px-8 py-8 px-lg-15 py-lg-3">
            ...
            <div class="wizard-step" data-wizard-type="step">
              <div class="wizard-label">
                <h3 class="wizard-title"><span>3</span> Period</h3>
                <div class="wizard-bar"></div>
              </div>
            </div>
            <div class="wizard-step" data-wizard-type="step">
              <div class="wizard-label">
                <h3 class="wizard-title"><span>4</span> Kontrollera</h3>
                <div class="wizard-bar"></div>
              </div>
            </div>
            <div class="wizard-step" data-wizard-type="step">
              <div class="wizard-label">
                <h3 class="wizard-title"><span>5</span> Import</h3>
                <div class="wizard-bar"></div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-12 col-xxl-7">
            ...
            <form class="form" id="kt_form">
              ...
              <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                <h4 class="mb-10 font-weight-bold text-dark">Medlemsregisterfil</h4>
                ...
                <div>
                  <b-alert show variant="secondary"
                    >Ladda upp ert medlemsregister i <strong>XLSX</strong> format. Ifall filen är
                  ...
                  <b-button type="button" variant="success" @click="selectFile()"
                    >Ladda upp medlemsregister</b-button
                  >
                </div>
              ...
              <!--begin: wizard step 3-->
              <div class="pb-5" data-wizard-type="step-content" data-wizard-state="pending">
                <h4 class="mb-10 font-weight-bold text-dark">Kontrollera period</h4>

                <b-alert show variant="secondary"
                  ><strong>{{ this.periodName }}</strong
                  ><br />Medlemmarna importeras till denna period</b-alert
                >
              </div>
              <!--end: wizard step 3-->
...
export default {
  ...
  methods: {
    ...
    readColumnDefFromFile(file_id) {
      axios
        .get(`/import/read_column_defs?type=clients&file_id=${file_id}`)
        .then(res => {
          if (res.status === 200) {
